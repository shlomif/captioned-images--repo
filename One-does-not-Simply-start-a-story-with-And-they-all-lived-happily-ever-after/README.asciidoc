...
image::./one-does-not-simply-not-know-who-marilyn-monroe-is.svg.webp[One does not simply say "no" to an Alpha Female]
...
edit it type:
    ...
    inkscape ./one-does-not-simply-not-know-who-marilyn-monroe-is.svg
